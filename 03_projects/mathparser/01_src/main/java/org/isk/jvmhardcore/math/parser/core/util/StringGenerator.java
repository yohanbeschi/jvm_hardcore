...
public class StringGenerator {
   ...
   * The characters of the String argument are appended, in order, increasing the length of this sequence by the length
   * of the argument. If string is null, then the four characters "null" are appended.<br>
   * Let n be the length of this character sequence just prior to execution of the append method. Then the character at
   * index k in the new character sequence is equal to the character at index k in the old character sequence, if k is
   * less than n; otherwise, it is equal to the character at index k-n in the argument string.
   * 
   * @param string
   ...
   * String.valueOf((char)integer), and the character in that string were then appended to this character sequence.
   * 
   * @param integer
   *          is the character to append
   */
  ...
  /**
   * Returns a string representing the data in this sequence and reset the sequence. A new String object is allocated
   * and initialized to contain the character sequence currently represented by this object. This String is then
