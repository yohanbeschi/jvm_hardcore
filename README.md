...
The method [assemblePjb()](http://github.com/yohanbeschi/jvm_hardcore/blob/part02/03_projects/bytecode/01_src/assembler/java/org/isk/jvmhardcore/bytecode/parttwo/Assembler#L46) takes all the files in the folder *pjb/* and its children regardless of their extension and invokes PJBA parser (available in the folder   *02\_libs* under the name *pjba.jar*).<br />
